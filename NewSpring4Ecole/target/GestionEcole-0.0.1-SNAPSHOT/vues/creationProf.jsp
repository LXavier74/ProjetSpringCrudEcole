...
<body>
<form:form method="post" modelAttribute="creationProf" action="creerCreationListeProfs">
<spring:message code="creation.elementprofs.libelle.nom" />
<form:input path="nom"/>
<b><i><form:errors path="nom" cssclass="error"/></i></b><br>
<spring:message code="creation.elementprofs.libelle.prenom"/>
<form:input path="prenom"/>
<b><i><form:errors path="prenom" cssclass="error"/></i></b><br>
<spring:message code="creation.elementprofs.libelle.date_naissance" />
<form:input path="date_naissance"/>
<b><i><form:errors path="date_naissance" cssclass="error"/></i></b><br>
<spring:message code="creation.elementprofs.libelle.adresse" />

<form:input path="adresse"/>
<b><i><form:errors path="adresse" cssclass="error"/></i></b><br>
<spring:message code="creation.elementprofs.libelle.sexe" />
